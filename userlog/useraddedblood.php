                        ...
                        <div class="panel-body">
							...
							if(isset($_POST['name'])){
								...
								if(!$result){
                                    ...
                                    echo" <a href='userdashboard.php' class='btn btn-primary'><i class='fa fa-arrow-left' aria-hidden='true'></i> Go Back</a>";

								}

							}else{
                                echo"<h3>YOU ARE NOT AUTHORIZED TO REDIRECT THIS PAGE.</h3>";
                                echo"<h3>GO BACK to <a href='userdashboard.php' class='btn btn-primary'> DASHBOARD </a></h3></div>";
							}
